...
@Component({
  selector: 'app-restaurant-admin-edit',
  templateUrl: './restaurant-admin-edit.component.html',
  styleUrls: ['./restaurant-admin-edit.component.css']
})
export class RestaurantAdminEditComponent implements OnInit {
  ...
  constructor(
    ...
    private matDialogRef: MatDialogRef<RestaurantAdminEditComponent>,
